package me.yablonskyi.eastside.adapter;
...
public class PictureListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void addAll(ArrayList<PictureDetail> list) {
        mPictureDetailArrayList.addAll(list);
        notifyDataSetChanged();
    }
    ...
    private boolean pictureInDatabase(String photoId) {
        ...
        Uri pictureContentUri = PictureDetailContract.PictureDetailEntry.CONTENT_URI;
            ...
            if (pictureDataCursor.moveToFirst()) {
                do {
                    String id = pictureDataCursor.getString(pictureDataCursor.getColumnIndex(
                            PictureDetailContract.PictureDetailEntry.COLUMN_PICTURE_ID));
            ...
            mFavouriteIconImageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mFavouriteIconImageView.getDrawable().getConstantState().equals(
                        ...
                        contentValues.put(PictureDetailContract.PictureDetailEntry.COLUMN_PICTURE_ID,
                                mPictureDetailArrayList.get(mPictureIndex).getPhotoId());
                        contentValues.put(PictureDetailContract.PictureDetailEntry.COLUMN_PICTURE_LIKES,
                                mPictureDetailArrayList.get(mPictureIndex).getPhotoLikes());
                        contentValues.put(PictureDetailContract.PictureDetailEntry.COLUMN_PICTURE_DOWNLOAD_URL,
                                mPictureDetailArrayList.get(mPictureIndex).getPhotoDownloadUrl());
                        contentValues.put(PictureDetailContract.PictureDetailEntry.COLUMN_PICTURE_THUMBNAIL_URL,
                                mPictureDetailArrayList.get(mPictureIndex).getPhotoThumbnailUrl());
                        contentValues.put(PictureDetailContract.PictureDetailEntry.COLUMN_PICTURE_AUTHOR_NAME,
                                mPictureDetailArrayList.get(mPictureIndex).getPhotoAuthorName());
                        contentValues.put(PictureDetailContract.PictureDetailEntry.COLUMN_PICTURE_AUTHOR_USERNAME,
                                mPictureDetailArrayList.get(mPictureIndex).getPhotoAuthorUserName());
                        contentValues.put(PictureDetailContract.PictureDetailEntry.COLUMN_PICTURE_COLOR,
                                mPictureDetailArrayList.get(mPictureIndex).getPhotoColor());
                        contentValues.put(PictureDetailContract.PictureDetailEntry.COLUMN_USER_PROFILE_PICTURE_URL,
                                mPictureDetailArrayList.get(mPictureIndex).getUserProfilePictureUrl());

                        //insert data into database
                        mContext.getContentResolver().insert(PictureDetailContract.PictureDetailEntry.CONTENT_URI,
                                contentValues);
                        ...
                        Uri pictureDetailUri = PictureDetailContract.PictureDetailEntry.CONTENT_URI;
                        String selection = PictureDetailContract.PictureDetailEntry.COLUMN_PICTURE_ID + "=?";
