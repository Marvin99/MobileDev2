                ...
                do {
                    PictureDetail singlePictureDetail = new PictureDetail(
                            ...
                            pictureDataCursor.getInt(pictureDataCursor.getColumnIndex(
                                    PictureDetailContract.PictureDetailEntry.COLUMN_PICTURE_LIKES)),
                            pictureDataCursor.getString(pictureDataCursor.getColumnIndex(
                                    PictureDetailContract.PictureDetailEntry.COLUMN_PICTURE_DOWNLOAD_URL)),
                            pictureDataCursor.getString(pictureDataCursor.getColumnIndex(
                                    PictureDetailContract.PictureDetailEntry.COLUMN_PICTURE_THUMBNAIL_URL)),
                            pictureDataCursor.getString(pictureDataCursor.getColumnIndex(
                                    PictureDetailContract.PictureDetailEntry.COLUMN_PICTURE_AUTHOR_NAME)),
                            pictureDataCursor.getString(pictureDataCursor.getColumnIndex(
                                    PictureDetailContract.PictureDetailEntry.COLUMN_PICTURE_AUTHOR_USERNAME)),
                            pictureDataCursor.getString(pictureDataCursor.getColumnIndex(
                                    PictureDetailContract.PictureDetailEntry.COLUMN_PICTURE_COLOR)),
                            pictureDataCursor.getString(pictureDataCursor.getColumnIndex(
                                    PictureDetailContract.PictureDetailEntry.COLUMN_USER_PROFILE_PICTURE_URL)));
