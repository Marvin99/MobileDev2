...
public class PictureDetailProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (matchPlaceUri) {
            case PICTURE:
                cursor = placeDetailDatabase.query(PictureDetailContract.PictureDetailEntry.PICTURE_TABLE_NAME,
                        projection, selection, selectionArgs, null, null, sortOrder);
                break;
            case PICTURE_ID:
                selection = PictureDetailContract.PictureDetailEntry._ID + "=?";
                selectionArgs = new String[]{String.valueOf(ContentUris.parseId(uri))};
                cursor = placeDetailDatabase.query(PictureDetailContract.PictureDetailEntry.PICTURE_TABLE_NAME, projection,
    ...
    private Uri insertPictureDetails(Uri uri, ContentValues values) {
        ...
        long id = placeDetailDatabase.insert(PictureDetailContract.PictureDetailEntry.PICTURE_TABLE_NAME, null, values);
        if (id == -1) {
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (matchPlaceUri) {
            case PICTURE:
                ...
                rowDeleted = placeDetailDatabase.delete(PictureDetailContract.PictureDetailEntry.PICTURE_TABLE_NAME,
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (matchPlaceUri) {
            case PICTURE:
                return PictureDetailContract.PictureDetailEntry.CONTENT_LIST_TYPE;
            case PICTURE_ID:
                return PictureDetailContract.PictureDetailEntry.CONTENT_ITEM_TYPE;
            default:
